...
var _ = _interopRequireDefault(require("/img/demo1/11.jpg"));

var _2 = _interopRequireDefault(require("/img/demo1/10.jpg"));

var _3 = _interopRequireDefault(require("/img/demo1/9.jpg"));
...
lscroll.on('scroll', function (args) {
  if (_typeof(args.currentElements['hey']) === 'object') {
    var el = args.currentElements['hey'];
    var progress = el.progress;
    var rotateDeg = 360 * progress;
    document.querySelectorAll('[data-scroll-id="hey"]')[0].style.transform = "rotate(".concat(rotateDeg, "deg)");
  }

  if (_typeof(args.currentElements['change-img']) === 'object') {
    var _el = args.currentElements['change-img'];
    var _progress = _el.progress;
    var imgFrame = document.querySelectorAll('[data-scroll-id="change-img"]')[0];

    if (0.4 <= _progress && _progress < 0.6) {
      imgFrame.style.backgroundImage = "url(".concat(_.default, ")");
    }

    if (0.2 <= _progress && _progress < 0.4) {
      imgFrame.style.backgroundImage = "url(".concat(_2.default, ")");
    }

    if (0 <= _progress && _progress < 0.2) {
      imgFrame.style.backgroundImage = "url(".concat(_3.default, ")");
    }
  }
...
},{"../utils":"js/utils.js","../cursor":"js/cursor.js","locomotive-scroll":"../node_modules/locomotive-scroll/dist/locomotive-scroll.esm.js","/img/demo1/11.jpg":"img/demo1/11.jpg","/img/demo1/10.jpg":"img/demo1/10.jpg","/img/demo1/9.jpg":"img/demo1/9.jpg"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
